...
pub fn render_generated_i18n_module(config: &I18nBuildConfig, src_root: &Path) -> String {
    let mut out =
        String::from("// @generated by pilcrow-routekit. Do not edit manually.\n");
    ...
    let default_locale_dir = src_root.join(&config.locales_dir).join(&config.default_locale);
