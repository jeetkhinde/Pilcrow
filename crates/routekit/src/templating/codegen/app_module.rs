...
pub fn render_generated_app_module(
            ...
            && deferred_html_fields.is_empty()
        {
            ...
            if has_any_deferred && !any_layout_load {
                ...
                if !live_fields.is_empty() {
                    ...
                    out.push_str("                let __live_anchor = format!(\"<div data-pilcrow-live style=\\\"display:none\\\" s-sse=\\\"/__pilcrow/live{}\\\"></div>\", __live_path);\n");
                    out.push_str(
    ...
    for entry in page_entries {
        ...
        out.push_str("    ];\n");
        out.push_str(
            "    ::pilcrow_web::__live_props_response(__live_streams, \"body\").into_response()\n",
        );
        out.push_str("}\n");
    }
