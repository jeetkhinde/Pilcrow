...
// Built: 2026-04-30T00:00:00.000Z
(function(){
"use strict";
// /debug.js
// ════════════════════════════════════════════════════════════
...
// ── SSR hydration seed ─────────────────────────────────────
// Pilcrow can inject `window.__pilcrow_props = { "/path": data, ... }`
// before silcrow boots. Seeding the route atom + prefetch cache lets
// React's useSyncExternalStore + use() return real data on first paint
// without a network roundtrip and with stable promise identity.
function seedAtomsFromSSR() {
  const seeds = (typeof window !== "undefined") ? window.__pilcrow_props : null;
